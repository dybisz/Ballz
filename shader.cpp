...
void Shader::printShaderLog(GLuint shader)
{
    ...
    {
        printf( "[Error] Id does not represents shaders object\n");
        throw logShdEx;
    }
}
 ...
 */
void Shader::getShaderParam(GLuint shader,  GLenum pname,  GLint *params)
{
 ...
 * error is just a suggestion that something went wrong.
 */
void Shader::getInfoLog(GLuint shader,  GLsizei  maxLength,  GLsizei * length,  GLchar * infoLog)
{
