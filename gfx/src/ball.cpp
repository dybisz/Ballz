...
Ball::Ball() : vertices(RINGS * SECTORS * DATA_PER_VERTEX), normals(RINGS * SECTORS * DATA_PER_NORMAL), indices(RINGS * SECTORS * DATA_PER_QUAD)
{
...
// TODO glm::vec3 center as a member of the class
/**
